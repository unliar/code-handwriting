...
### 22. [找出数组中比左边都大比右边都小的数](/leetcode/array/#_22-找出数组中比左边都大比右边都小的数)

### 23. [数组原地去重](/leetcode/array/#_23-数组原地去重)

### 24. [数组拍平](/leetcode/array/#_24-数组拍平)

### 25. [数组数字奇数偶数排序](/leetcode/array/#_25-数组数字奇数偶数排序)

### 26. [旋转二维数组](/leetcode/array/#_26-旋转二维数组)

### 27. [有序数组是否是子序列](/leetcode/array/#_27-有序数组是否是子序列)

### 28. [面试题 10.02. 变位词组](/leetcode/array/#_28-面试题-10-02-变位词组)
...
### 1. [168. Excel表列名称-数字转成A-Z](/leetcode/number/#_1-168-excel表列名称-数字转成a-z)

### 2. [171. Excel表列序号-字符转数字](/leetcode/number/#_2-171-excel表列序号-字符转数字)

### 3. [x 的 n 次方](/leetcode/number/#_3-x-的-n-次方)

### 4. [x 的平方根](/leetcode/number/#_4-x-的平方根)

### 5. [从 n 个数中同概率的选出 m 个数字](/leetcode/number/#_5-从-n-个数中同概率的选出-m-个数字)

### 6. [剑指 Offer 10- I. 斐波那契数列](/leetcode/number/#_6-剑指-offer-10-i-斐波那契数列)

### 7. [剑指 Offer 16. 数值的整数次方](/leetcode/number/#_7-剑指-offer-16-数值的整数次方)

### 8. [剑指 Offer 17. 打印从 1 到最大的 n 位数](/leetcode/number/#_8-剑指-offer-17-打印从-1-到最大的-n-位数)

### 9. [剑指 Offer 49. 丑数](/leetcode/number/#_9-剑指-offer-49-丑数)

### 10. [剑指 Offer 64. 求 1+2+…+n](/leetcode/number/#_10-剑指-offer-64-求-1-2-n)

### 11. [射击运动员10枪90环的所有可能](/leetcode/number/#_11-射击运动员10枪90环的所有可能)

### 12. [整数反转](/leetcode/number/#_12-整数反转)

### 13. [是否是质数](/leetcode/number/#_13-是否是质数)

### 14. [爬楼梯问题](/leetcode/number/#_14-爬楼梯问题)
...
### 3. [二进制数中 1 的个数](/leetcode/string/#_3-二进制数中-1-的个数)

### 4. [出现次数最多的三个字符](/leetcode/string/#_4-出现次数最多的三个字符)

### 5. [判断是否是回文数](/leetcode/string/#_5-判断是否是回文数)

### 6. [剑指 Offer 05. 替换空格](/leetcode/string/#_6-剑指-offer-05-替换空格)

### 7. [剑指 Offer 15. 二进制中 1 的个数](/leetcode/string/#_7-剑指-offer-15-二进制中-1-的个数)

### 8. [剑指 Offer 38. 字符串的排列](/leetcode/string/#_8-剑指-offer-38-字符串的排列)

### 9. [剑指 Offer 48. 最长不含重复字符的子字符串](/leetcode/string/#_9-剑指-offer-48-最长不含重复字符的子字符串)

### 10. [剑指 Offer 50. 第一个只出现一次的字符](/leetcode/string/#_10-剑指-offer-50-第一个只出现一次的字符)

### 11. [大数相加](/leetcode/string/#_11-大数相加)

### 12. [字符串的全排列](/leetcode/string/#_12-字符串的全排列)

### 13. [最长回文子串](/leetcode/string/#_13-最长回文子串)